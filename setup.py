...
if os.name == 'morphos':
    ...
    defines = [('NDEBUG', None), ('__MORPHOS_SHAREDLIBS', None)]
...
ext_savers = Extension(
    'model/_savers',
    ['src/_saversmodule.c'] + pb_srcs,
    define_macros=defines,
    extra_compile_args=opt,
    extra_link_args=link_opt,
)

ext_render_gl = Extension(
    'view/pymui/_glbackend',
    ['src/_glbackend.c'] + pb_srcs,
    define_macros=defines,
    extra_compile_args=opt,
    extra_link_args=link_opt,
)
